...
public class RetroSun extends PApplet {
	...
	public void draw() {
		...
		int missingSectionTopY = height / 2 - sunRadius + 125;
		int missingSectionBottomY = height - (height / 2 - sunRadius);
		...
		sections.add(new Rectangle(x,y+55,w,h));
		sections.add(new Rectangle(x,y+110,w,h));
		sections.add(new Rectangle(x,y+165,w,h));
		sections.add(new Rectangle(x,y+220,w,h));
		...
		for(int i = 0; i<sections.size(); i++) {
			...
			if (sections.get(i).y < height / 2 - sunRadius + 125) {
				sections.get(i).y = height - (height / 2 - sunRadius);
			}
			
			missingSectionTopY = height / 2 - sunRadius + 125;
			missingSectionBottomY = height - (height / 2 - sunRadius);

			sections.get(i).h = map(sections.get(i).y, missingSectionTopY, missingSectionBottomY, 1, 40);
